          ...
          {tournaments.length > 0 && (
            <div className="mb-8">
              ...
              <select
                ...
                className="px-4 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 max-w-md mx-auto"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            {teams.map((team) => (
              <Link
                ...
                className="bg-white rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 p-6 flex flex-col items-center justify-center min-h-[200px] transform hover:scale-105 cursor-pointer"
              >
                ...
                <h3 className="text-lg font-semibold text-gray-800 text-center hover:text-orange-600 transition-colors">
                  {team.name}
                </h3>
                {team.description && (
