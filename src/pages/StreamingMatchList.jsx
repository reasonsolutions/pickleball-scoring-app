...
export default function StreamingMatchList() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Sort fixtures by date, time, match type, and match order (identical to UmpireMatchList)
  ...
  const handleFixtureClick = (fixtureGroup) => {
    // Navigate to streaming fixture details page showing individual matches
    navigate(`/streaming-matches/${tournamentId}/fixture/${fixtureGroup.id}`);
  };
    ...
    <div className="min-h-screen bg-base-200">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-primary mb-2">Streaming Match List</h1>
          <h2 className="text-2xl font-semibold mb-4">{tournament?.name}</h2>
          <p className="text-base-content/70">Click on any fixture to view streaming overlay options</p>
        </div>
        ...
        <div className="text-center mb-6">
          <div className="stats shadow">
            <div className="stat">
              ...
              <div className="stat-value text-warning">{filteredFixtureGroups.length}</div>
