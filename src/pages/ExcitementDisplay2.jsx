...
export default function ExcitementDisplay2() {
      ...
      try {
        ...
        try {
          ...
          if (displaySettingDoc.exists()) {
            ...
            // Fetch team data for the current fixture to get player images - FOR TEAM 2
            if (currentMainFixture && currentMainFixture.team2Name) {
              try {
                const teamsQuery = query(
                  collection(db, 'teams'),
                  where('tournamentId', '==', tournamentId),
                  where('name', '==', currentMainFixture.team2Name)
                );
  ...
  return (
    ...
    >
      ...
      {/* Left Side - Team Logo (40ft width, 4ft height) - NOW SHOWING TEAM 2 */}
      <div className="absolute left-0 top-0 h-full flex items-center justify-center" style={{ width: '50%' }}>
        {currentFixture && currentFixture.team2Name ? (
          <div className="flex items-center justify-center h-full w-full relative">
            ...
            <div className="flex items-center justify-center w-full relative">
              ...
              <div className="absolute" style={{ left: '12.5%' }}>
                <img
                  src={getTeamLogo(currentFixture.team2Name)}
                  alt={`${currentFixture.team2Name} Logo Left`}
              ...
              <div className="absolute" style={{ right: '12.5%' }}>
                <img
                  src={getTeamLogo(currentFixture.team2Name)}
                  alt={`${currentFixture.team2Name} Logo Right`}
