...
export default function AdminDashboard() {
  const { currentUser, isTeamAdmin } = useAuth();
  ...
  return (
    <MainLayout>
      <div className="max-w-4xl mx-auto">
        ...
        {/* Quick Stats - Hidden for Team Admins */}
        {!isTeamAdmin() && (
          <>
        ...
        {/* Team Admin View - Only show tournaments link */}
        {isTeamAdmin() && (
          <div className="card shadow-xl card-fitMove" style={{ backgroundColor: 'var(--bg-card)' }}>
            <div className="card-body">
              <h2 className="card-title text-2xl mb-4" style={{ color: 'var(--text-primary)' }}>Team Admin Actions</h2>
