          ...
          <div className="container mx-auto px-4 py-8">
            <div className="flex justify-center items-center min-h-[400px]">
              <div className="text-center">
                ...
                <p className="text-gray-300" style={{ fontFamily: 'Avantique, sans-serif' }}>Loading team details...</p>
              </div>
            </div>
          </div>
        </div>
  ...
  return (
    <>
      ...
      <div className="min-h-screen" style={{ backgroundColor: '#212121' }}>
        ...
        <div className="container mx-auto px-4 py-8">
          {/* Breadcrumb */}
          <nav className="mb-8 text-sm" style={{ fontFamily: 'Avantique, sans-serif' }}>
            <Link to="/" className="text-gray-400 hover:text-gray-300">Home</Link>
            <span className="mx-2 text-gray-500">/</span>
            <Link to="/teams" className="text-gray-400 hover:text-gray-300">Teams</Link>
            <span className="mx-2 text-gray-500">/</span>
          ...
          <div className="bg-gray-800 rounded-lg shadow-lg overflow-hidden border border-gray-700">
            ...
            <div className="bg-gradient-to-r from-orange-400 to-orange-600 px-6 py-8 md:px-12 md:py-12">
              <div className="flex flex-col md:flex-row items-center justify-between">
                <div className="text-center md:text-left mb-6 md:mb-0">
                  <h1 className="text-3xl md:text-5xl font-bold text-white mb-2 uppercase tracking-wide" style={{ fontFamily: 'Avantique, sans-serif' }}>
                    {team.name}
                  </h1>
                  {tournament && (
                    <p className="text-orange-100 text-lg" style={{ fontFamily: 'Avantique, sans-serif' }}>
            ...
            <div className="p-6 md:p-12">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                {/* Team Ranking */}
                <div className="text-center">
                  <div className="text-4xl md:text-6xl font-bold text-white mb-2" style={{ fontFamily: 'Avantique, sans-serif' }}>
                    #{teamRanking}
                  </div>
                  <div className="text-gray-300 font-medium uppercase tracking-wide" style={{ fontFamily: 'Avantique, sans-serif' }}>
                    Team Ranking
                  </div>
                </div>
                ...
                <div className="text-center">
                  ...
                  <div className="text-sm text-gray-400 mt-1" style={{ fontFamily: 'Avantique, sans-serif' }}>
          ...
          <div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-gray-800 rounded-lg shadow-lg p-6 border border-gray-700">
              <h2 className="text-2xl font-bold text-white mb-6" style={{ fontFamily: 'Avantique, sans-serif' }}>Player Summary</h2>
              
              {team.players && team.players.length > 0 ? (
                <div className="space-y-4">
                  {team.players.map((player, index) => (
                    <div key={player.id || index} className="flex items-center p-4 bg-gray-700 rounded-lg border-l-4 border-orange-500">
                      {/* Player Photo */}
                      ...
                      <div className="flex-grow">
                        <div className="flex items-center justify-between">
                          <div>
                            <h3 className="text-lg font-semibold text-white" style={{ fontFamily: 'Avantique, sans-serif' }}>{player.name}</h3>
                          </div>
                          
                          {/* DUPR Ratings */}
                          <div className="text-right">
                            <div className="mb-2">
                              <div className="text-2xl font-bold text-orange-500" style={{ fontFamily: 'Avantique, sans-serif' }}>
                                {player.doublesRating || '0.00'}
                              </div>
                              <div className="text-xs text-gray-400 uppercase tracking-wide" style={{ fontFamily: 'Avantique, sans-serif' }}>
                                Doubles<br />DUPR Rating
                              </div>
                            </div>
                            {player.singlesRating && (
                              <div>
                                <div className="text-lg font-semibold text-gray-300" style={{ fontFamily: 'Avantique, sans-serif' }}>
                                  {player.singlesRating}
                                </div>
                                <div className="text-xs text-gray-400 uppercase tracking-wide" style={{ fontFamily: 'Avantique, sans-serif' }}>
                ...
                <div className="text-center py-8 text-gray-400">
                  ...
                  <p style={{ fontFamily: 'Avantique, sans-serif' }}>No players found for this team</p>
                </div>
              )}
            </div>
            ...
            <div className="bg-gray-800 rounded-lg shadow-lg p-6 border border-gray-700">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl font-bold text-white" style={{ fontFamily: 'Avantique, sans-serif' }}>ABOUT {team.name.toUpperCase()}</h2>
              ...
              <div className="text-gray-300 leading-relaxed">
                {team.description ? (
                  <p className="mb-4" style={{ fontFamily: 'Avantique, sans-serif' }}>{team.description}</p>
                ) : (
                  <div className="text-center py-8 text-gray-400">
                    <p style={{ fontFamily: 'Avantique, sans-serif' }}>Team description not available.</p>
                  </div>
                )}
              </div>
            </div>
